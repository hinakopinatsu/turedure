...
type View = "gathering" | "letters" | "mine";
...
const nav: { id: View; label: string }[] = [
  { id: "mine", label: "我が歌" }, { id: "gathering", label: "歌会" }, { id: "letters", label: "文箱" },
];
...
function Gathering({ unlocked, onPeek, onReply, onOpenReplies, publicExchanges }: { unlocked: boolean; onPeek: (poem: Poem) => void; onReply: (poem: Poem) => void; onOpenReplies: (exchanges: Exchange[]) => void; publicExchanges: Exchange[] }) {
  const [page, setPage] = useState(0); const [poems, setPoems] = useState(samplePoems);
