...
const scents:Record<ScentKey,{name:string;note:string;arrival:string}>={baika:{name:"梅花",note:"澄んだ、凛とした気配",arrival:"梅花の香、ほのかに残れり"},kayo:{name:"荷葉",note:"水辺のような、涼やかな気配",arrival:"荷葉の香、涼やかに残れり"},kikka:{name:"菊花",note:"静かで、澄んだ余韻",arrival:"菊花の香、静かに残れり"},kurobo:{name:"黒方",note:"深く、夜のような気配",arrival:"黒方の香、深く残れり"}};
const branches:Record<BranchKey,{name:string;note:string;season:Season}>={ume:{name:"梅",note:"凛とした、ひそやかな気配",season:"spring"},yamabuki:{name:"山吹",note:"明るく、やわらかな気配",season:"spring"},fuji:{name:"藤",note:"たおやかで、余韻のある気配",season:"spring"},tachibana:{name:"橘",note:"清らかで、懐かしい気配",season:"summer"},unohana:{name:"卯の花",note:"白く、かすかな気配",season:"summer"},hasu:{name:"蓮",note:"水辺にひらく静かな気配",season:"summer"},hagi:{name:"萩",note:"秋風にほどける気配",season:"autumn"},susuki:{name:"薄",note:"風に揺れる、淡い気配",season:"autumn"},kiku:{name:"菊",note:"澄みわたる静かな気配",season:"autumn"},matsu:{name:"松",note:"静かで、変わらぬ気配",season:"winter"},ume_winter:{name:"寒梅",note:"寒気に咲く凛とした気配",season:"winter"},snow_branch:{name:"雪折れの枝",note:"雪の重みを残す気配",season:"winter"}};
